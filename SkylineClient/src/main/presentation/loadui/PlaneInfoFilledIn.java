...
public class PlaneInfoFilledIn {
	...
	private JLabel PlaneNum;//航运编号标签
	private JLabel flightNum;//航班号标签
	...
	int panelHeight=0;
		...
		public void addElements(){
			PlaneNum=new JLabel("中转中心编号");
			flightNum=new JLabel("订单单号");
			...
			flightNum.setLocation(panelWidth*3/69,panelHeight*185/550+panelHeight*185/550-panelHeight/2-panelHeight/7+panelHeight*105/550);
			...
			PlaneNum.setLocation(panelWidth*3/69,panelHeight*185/550+(panelHeight*185/550-panelHeight/2-panelHeight/7+panelHeight*105/550)*2);
